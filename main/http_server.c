...
/*
esp_err_t http_get_time_handler(httpd_req_t *req) {
    // Obtiene la hora actual usando la biblioteca NTP
    time_t now = ntp_time_get();
    struct tm timeinfo;
    ...
    // Enviar la hora como respuesta HTTP
    httpd_resp_send(req, strftime_buf, HTTPD_RESP_USE_STRLEN);
    return ESP_OK;
}
*/
...
*/
		...
		// Durante la configuración del servidor HTTP
